export default {
  ...
  'menu.main_page': '首頁',
  'menu.customer_management': '客戶管理',
  'menu.project_management': '項目管理',
  'menu.workingHour_management': '工時管理',
  'menu.workingHour_management_calendar': '工時日曆',
  'menu.account_management': '賬戶管理',
  'menu.member_management': '人員管理',
};
